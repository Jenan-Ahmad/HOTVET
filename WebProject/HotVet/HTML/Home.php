...
<div id="draggable" class="ui-widget-content theme" style="background-color: #2a2b2e !important;" onclick="swapStyleSheet();">
     ...
     try {
         ...
         for($i =0;$i<$res->num_rows;$i++){
             ...
             <div id="contentId" class="container" >
                 ...
                 <img src="<?php echo $pic ?>"  style="float: right; width:35vh; height: 30vh; margin-bottom: 50px; display: inline-block" alt="">
                 <p>
                     <?php echo $text ?>
                 </p>
             </div>
