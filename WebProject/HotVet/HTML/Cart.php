...
<head>
    ...
    <link rel="stylesheet" href="../CSS/Cart.css" id="cssPage">
...
//                $queryx = 'select price from item where item_id = ' . $_POST['deleteiconbutton'] . ';';
    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse " id="nvbCollapse">
            <ul class="navbar-nav  ms-auto">
                ...
                <li class="nav-item ms-auto">
                    <!--                    <a class="nav-link cart position-relative d-inline-flex" href="Cart.php?cart_id=">-->
...
<fieldset class="p-4 pb-0">
    <legend class="float-none w-auto">Fill your info</legend>
