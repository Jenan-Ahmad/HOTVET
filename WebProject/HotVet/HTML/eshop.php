        ...
        <div class="collapse navbar-collapse " id="nvbCollapse">
            <ul class="navbar-nav  ms-auto">
                <li class="nav-item ms-auto">
                    <a class="nav-link" href="../html/appointment.php">Profile</a>
                </li>
                <li class="nav-item ms-auto">
                    <a class="nav-link" href="../html/Pets.php">Pets</a>
                </li>
                <li class="nav-item ms-auto">
                    <a class="nav-link" href="../html/appointment.php">Shop</a>
                </li>
                <li class="nav-item ms-auto">
...
<div class="header">
    ...
    <div class="container p-0 w-50" style="margin: 15vh; margin-left: 25%">
        <form method="post" enctype="multipart/form-data">
            <div style="text-align: center; background-color: #f8f9fa; margin: 4vh; padding: 2vh; border: .3vh solid #099aac; border-radius: 10%;">
