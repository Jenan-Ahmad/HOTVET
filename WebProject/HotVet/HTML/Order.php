...
<head>
    ...
    <!-- css page -->
    <link rel="stylesheet" href="../CSS/darkTemplate.css" id="template">
    <link rel="stylesheet" href="../CSS/Orderdark.css" id="cssPage">
...
<div id="containment">
    ...
    <div class="split left">
        <div class="containerOrders">
            <?php $query = "SELECT cart_id FROM `storeorders` where `c_username` = '" . $_SESSION['userID'] . "' ;";
