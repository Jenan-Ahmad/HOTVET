...
<!--still old design kept for reference when everything breaks down-->
<fieldset class="p-5 ml-2">
    <legend class="float-none w-auto p-2">Collars & Tags</legend>
    <div class=" container container-fluid">
        <?php
                    ...
                    <div class="flip-card-inner">
                        ...
                        <div class="flip-card-back">
                            ...
                            <p>
                                <button type="button" class="btn" style="background-color: white;"></button>
                                <button type="button" class="btn" style="background-color: pink;"></button>
                                <button type="button" class="btn" style="background-color: cornflowerblue;"></button>
                            </p>
                            <p style="color: black; margin-bottom: 0">Price: <?php echo $row ['price']; ?>$</p>
                            <p>
                                <button type="button" class="btn" id="<?php echo $row ['item_id']; ?>">
                                    <i class="bi bi-cart-plus"></i>
                                </button>
                                <i class="bi bi-three-dots details"
                                   style="font-size: 16px;color: #818181;"></i>
                            </p>
